...
/**
 * Created by Jammer on 30/08/2016.
 */
public class ItemSpikedClub extends ItemSword implements ITexturedItem, IHandHeld {
        public ItemSpikedClub(ToolMaterial material) {
            super(material);
        ...
        public String getTextureName(int i) {
            return "advancedweaponarsenal:spikedclub";
        }
